...
const validateFns = require('./middlewares/validateFns');
...
exports.appRoute = router => {
    ...
    router.post('/api/user/process-submission',
        checkUserFn.getClientUserId, validateFns.validateSubmission, userController.processDesignSubmission);
    router.put('/api/user/', checkUserFn.isAdminUser, userController.processUpdateOneUser);
