...
const { logger, routerLogger } = require('./src/logger');
...
app.use(expressWinston.logger({
    winstonInstance: routerLogger,
    metaField: 'routerState',
    expressFormat: true
}));
...
app.listen(PORT, err => {
    if (err) return logger.error(`Cannot Listen on PORT: ${PORT}`, err);
